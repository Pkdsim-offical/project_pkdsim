using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.IdleTo
{
