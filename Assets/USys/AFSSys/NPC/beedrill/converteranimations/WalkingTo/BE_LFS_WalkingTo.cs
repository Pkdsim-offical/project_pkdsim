using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.converteranimations.WalkingTo
{
