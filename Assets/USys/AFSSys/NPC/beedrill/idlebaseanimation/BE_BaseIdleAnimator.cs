using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Beedrill.idlebaseanimation
{
