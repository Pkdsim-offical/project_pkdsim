using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.idlebaseanimation;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.movementbasedanimations;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.Animator_I
{
