using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo
{
