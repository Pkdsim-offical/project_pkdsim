using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.converteranimations.SittingTo
{
