using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Blaziken.idlebaseanimation
{
