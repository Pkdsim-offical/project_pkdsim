using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Braixen.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Braixen.movementbasedanimations.Turning.TurnRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Braixen.movementbasedanimations.Turning
{
