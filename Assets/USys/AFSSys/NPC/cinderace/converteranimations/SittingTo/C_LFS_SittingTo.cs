using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;
using Unity.Entities.UniversalDelegates;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.converteranimations.SittingTo
{
