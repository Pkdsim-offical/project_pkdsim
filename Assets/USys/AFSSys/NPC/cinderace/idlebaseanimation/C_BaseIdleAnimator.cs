using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Cinderace.idlebaseanimation
{
