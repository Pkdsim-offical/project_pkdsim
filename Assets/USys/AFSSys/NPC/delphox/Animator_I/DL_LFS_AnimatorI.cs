using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.idlebaseanimation;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.movementbasedanimations;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.Animator_I
{
