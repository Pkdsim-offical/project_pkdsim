using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.movementbasedanimations.Turning.TurnRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Delphox.movementbasedanimations.Turning
{
