using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Dragapult.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Dragapult.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Dragapult.idlebaseanimation
{
