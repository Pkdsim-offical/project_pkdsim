using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Espeon.converteranimations;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Espeon.idlebaseanimation;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Espeon.movementbasedanimations;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Espeon.Animator_I
{
