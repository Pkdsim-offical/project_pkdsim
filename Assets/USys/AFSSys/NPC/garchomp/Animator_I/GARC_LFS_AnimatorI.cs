using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.idlebaseanimation;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.movementbasedanimations;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.Animator_I
{
