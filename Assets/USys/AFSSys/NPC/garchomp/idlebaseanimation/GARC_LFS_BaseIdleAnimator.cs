using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Garchomp.idlebaseanimation
{
