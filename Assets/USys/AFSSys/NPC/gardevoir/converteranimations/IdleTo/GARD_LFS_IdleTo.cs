using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.converteranimations.IdleTo
{
