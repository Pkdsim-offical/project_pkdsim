using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Gardevoir.idlebaseanimation
{
