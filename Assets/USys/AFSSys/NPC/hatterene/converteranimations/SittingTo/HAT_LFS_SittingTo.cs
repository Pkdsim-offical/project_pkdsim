using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.SittingTo
{
