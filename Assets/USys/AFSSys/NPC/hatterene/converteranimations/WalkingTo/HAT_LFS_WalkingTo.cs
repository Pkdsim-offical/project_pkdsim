using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo
{
