using project_pkdsim.Assets.Models.ANIMATOR.NPC.Jolteon.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Jolteon.movementbasedanimations.Turning.TurnRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Jolteon.movementbasedanimations.Turning
{
