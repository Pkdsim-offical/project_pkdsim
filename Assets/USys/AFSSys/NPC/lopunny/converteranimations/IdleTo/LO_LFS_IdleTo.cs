using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.IdleTo
{
