using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.converteranimations.WalkingTo
{
