using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lopunny.idlebaseanimation
{
