using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lunala.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lunala.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Lunala.idlebaseanimation
{
