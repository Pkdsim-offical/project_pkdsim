using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.idlebaseanimation
{
