using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Turning.TurnRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Turning
{
