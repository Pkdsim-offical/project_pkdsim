using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.idlebaseanimation
{
