using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.movementbasedanimations.Turning.TurnRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Noivern.movementbasedanimations.Turning
{
