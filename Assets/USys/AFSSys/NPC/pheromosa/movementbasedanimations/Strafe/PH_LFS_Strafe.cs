using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Strafe.StrafeLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Strafe.StrafeRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Strafe
{
