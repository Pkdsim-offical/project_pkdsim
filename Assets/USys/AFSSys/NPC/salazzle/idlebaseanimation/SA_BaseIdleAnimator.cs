using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Salazzle.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Salazzle.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Salazzle.idlebaseanimation
{
