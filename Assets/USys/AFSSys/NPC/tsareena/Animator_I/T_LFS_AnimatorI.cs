using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.idlebaseanimation;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.movementbasedanimations;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.Animator_I
{
