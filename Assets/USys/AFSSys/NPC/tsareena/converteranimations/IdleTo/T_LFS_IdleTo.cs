using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.converteranimations.IdleTo
{
