...
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.converteranimations.WalkingTo.WalkingToSitting;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.converteranimations.WalkingTo
{
