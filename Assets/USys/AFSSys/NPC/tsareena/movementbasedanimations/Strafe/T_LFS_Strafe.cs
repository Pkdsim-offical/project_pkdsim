using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.movementbasedanimations.Strafe.StrafeLeft;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.movementbasedanimations.Strafe.StrafeRight;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Tsareena.movementbasedanimations.Strafe
{
