using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.SittingTo
{
