using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.converteranimations.WalkingTo
{
