using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.USys.AFSSys.ANIMATOR.NPC.Zoroark.idlebaseanimation
{
