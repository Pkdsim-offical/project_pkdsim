using project_pkdsim.Assets.USys.ITEMSSys.ITEMS.ItemsScripts.Gifts.Necklaces.Beam_necklace;
using project_pkdsim.Assets.USys.ITEMSSys.ITEMS.ItemsScripts.Gifts.Necklaces.I.Base_Properties;
using System.IO;
using Newtonsoft.Json;
using UnityEngine;

namespace project_pkdsim.Assets.USys.ITEMSSys.ITEMS.ItemsScripts.Gifts.Necklaces.I.Properties.LoadJson.Beam_necklace
{
    public class Beam_necklaceJsonLoader : MonoBehaviour
    {
        ...
        public void LoadJson()
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                necklaceData = JsonConvert.DeserializeObject<Beam_NecklaceItem>(jsonContent);
                Debug.Log("Loaded Beam_necklace data successfully.");
            }
            else
            {
                Debug.LogError("Beam_necklace.json file not found.");
            }
        }
        ...
        public void BeamNecklace_LoveSys_Stager()
        {
            LoadJson();
