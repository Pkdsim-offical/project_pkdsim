...
public class Beedrill_LL : LOVE_Asys
{
    ...
    public void Beedrill_LL0()
    {
        ...
        if (Beedrill_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Beedrill_LL3 = true;
        }
        if (Beedrill_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Beedrill_LL4 = true;
        }
        if (Beedrill_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Beedrill_LL5 = true;
        }
        if (Beedrill_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Beedrill_LL6 = true;
        }
    }
