...
public class Blaziken_LL : LOVE_Asys
{
    ...
    public void Blaziken_LL0()
    {
        ...
        if (Blaziken_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Blaziken_LL1 = true;
        }
        if (Blaziken_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Blaziken_LL2 = true;
        }
        if (Blaziken_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Blaziken_LL3 = true;
        }
        if (Blaziken_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Blaziken_LL4 = true;
        }
        if (Blaziken_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Blaziken_LL5 = true;
        }
        if (Blaziken_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Blaziken_LL6 = true;
        }
    }
