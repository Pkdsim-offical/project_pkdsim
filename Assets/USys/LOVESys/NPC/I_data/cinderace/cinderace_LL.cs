...
public class Cinderace_LL : LOVE_Asys
{
    ...
    public void Cinderace_LL0()
    {
        ...
        if (Cinderace_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Cinderace_LL1 = true;
        }
        if (Cinderace_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Cinderace_LL2 = true;
        }
        if (Cinderace_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Cinderace_LL3 = true;
        }
        if (Cinderace_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Cinderace_LL4 = true;
        }
        if (Cinderace_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Cinderace_LL5 = true;
        }
        if (Cinderace_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Cinderace_LL6 = true;
        }
    }
