...
public class Glaceon_LL : LOVE_Asys
{
    ...
    public void Glaceon_LL0()
    {
        ...
        if (Glaceon_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Glaceon_LL1 = true;
        }
        if (Glaceon_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Glaceon_LL2 = true;
        }
        if (Glaceon_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Glaceon_LL3 = true;
        }
        if (Glaceon_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Glaceon_LL4 = true;
        }
        if (Glaceon_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Glaceon_LL5 = true;
        }
        if (Glaceon_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Glaceon_LL6 = true;
        }
    }
