...
public class Jolteon_LL : LOVE_Asys
{
    ...
    public void Jolteon_LL0()
    {
        ...
        if (Jolteon_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Jolteon_LL1 = true;
        }
        if (Jolteon_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Jolteon_LL2 = true;
        }
        if (Jolteon_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Jolteon_LL3 = true;
        }
        if (Jolteon_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Jolteon_LL4 = true;
        }
        if (Jolteon_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Jolteon_LL5 = true;
        }
        if (Jolteon_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Jolteon_LL6 = true;
        }
    }
