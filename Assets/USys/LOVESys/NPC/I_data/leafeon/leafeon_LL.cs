...
public class Leafeon_LL : LOVE_Asys
{
    ...
    public void Leafeon_LL0()
    {
        ...
        if (Leafeon_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Leafeon_LL1 = true;
        }
        if (Leafeon_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Leafeon_LL2 = true;
        }
        if (Leafeon_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Leafeon_LL3 = true;
        }
        if (Leafeon_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Leafeon_LL4 = true;
        }
        if (Leafeon_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Leafeon_LL5 = true;
        }
        if (Leafeon_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Leafeon_LL6 = true;
        }
    }
