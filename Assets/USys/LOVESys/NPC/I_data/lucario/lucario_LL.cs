...
public class Lucario_LL : LOVE_Asys
{
    ...
    public void Lucario_LL0()
    {
        ...
        if (Lucario_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Lucario_LL1 = true;
        }
        if (Lucario_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Lucario_LL2 = true;
        }
        if (Lucario_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Lucario_LL3 = true;
        }
        if (Lucario_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Lucario_LL4 = true;
        }
        if (Lucario_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Lucario_LL5 = true;
        }
        if (Lucario_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Lucario_LL6 = true;
        }
    }
