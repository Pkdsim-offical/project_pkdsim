...
public class Meowscarada_LL : LOVE_Asys
{
    ...
    public void Meowscarada_LL0()
    {
        ...
        if (Meowscarada_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Meowscarada_LL1 = true;
        }
        if (Meowscarada_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Meowscarada_LL2 = true;
        }
        if (Meowscarada_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Meowscarada_LL3 = true;
        }
        if (Meowscarada_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Meowscarada_LL4 = true;
        }
        if (Meowscarada_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Meowscarada_LL5 = true;
        }
        if (Meowscarada_LL6 == base.LoveLevel_ProgressStates[5])
        {
