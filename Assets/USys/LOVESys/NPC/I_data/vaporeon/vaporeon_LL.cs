...
public class Vaporeon_LL : LOVE_Asys
{
    ...
    public void Vaporeon_LL0()
    {
        ...
        if (Vaporeon_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Vaporeon_LL1 = true;
        }
        if (Vaporeon_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Vaporeon_LL2 = true;
        }
        if (Vaporeon_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Vaporeon_LL3 = true;
        }
        if (Vaporeon_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Vaporeon_LL4 = true;
        }
        if (Vaporeon_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Vaporeon_LL5 = true;
        }
        if (Vaporeon_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Vaporeon_LL6 = true;
        }
    }
