...
public class Vespiquen_LL : LOVE_Asys
{
    ...
    public void Vespiquen_LL0()
    {
        ...
        if (Vespiquen_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Vespiquen_LL1 = true;
        }
        if (Vespiquen_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Vespiquen_LL2 = true;
        }
        if (Vespiquen_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Vespiquen_LL3 = true;
        }
        if (Vespiquen_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Vespiquen_LL4 = true;
        }
        if (Vespiquen_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Vespiquen_LL5 = true;
        }
        if (Vespiquen_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Vespiquen_LL6 = true;
        }
    }
