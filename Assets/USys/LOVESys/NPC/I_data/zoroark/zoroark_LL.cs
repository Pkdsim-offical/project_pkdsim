...
public class Zoroark_LL : LOVE_Asys
{
    ...
    public void Zoroark_LL0()
    {
        ...
        if (Zoroark_LL1 == base.LoveLevel_ProgressStates[0])
        {
            Zoroark_LL1 = true;
        }
        if (Zoroark_LL2 == base.LoveLevel_ProgressStates[1])
        {
            Zoroark_LL2 = true;
        }
        if (Zoroark_LL3 == base.LoveLevel_ProgressStates[2])
        {
            Zoroark_LL3 = true;
        }
        if (Zoroark_LL4 == base.LoveLevel_ProgressStates[3])
        {
            Zoroark_LL4 = true;
        }
        if (Zoroark_LL5 == base.LoveLevel_ProgressStates[4])
        {
            Zoroark_LL5 = true;
        }
        if (Zoroark_LL6 == base.LoveLevel_ProgressStates[5])
        {
            Zoroark_LL6 = true;
        }
    }
