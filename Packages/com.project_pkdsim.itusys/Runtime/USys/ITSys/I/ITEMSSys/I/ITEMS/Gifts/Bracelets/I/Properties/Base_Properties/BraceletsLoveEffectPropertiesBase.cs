...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Bracelets.Modules.Base_Properties
{
    public class BraceletsLoveEffectPropertiesBase : MonoBehaviour
    {
