...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Bracelets.Modules.Elemental_Effect
{
    public class BraceletsElementalEffectPropertiesBase : MonoBehaviour
    {
