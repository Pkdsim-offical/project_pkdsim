...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Earrings.Modules.Base_Properties
{
    public class EarringsLoveEffectPropertiesBase : MonoBehaviour
    {
