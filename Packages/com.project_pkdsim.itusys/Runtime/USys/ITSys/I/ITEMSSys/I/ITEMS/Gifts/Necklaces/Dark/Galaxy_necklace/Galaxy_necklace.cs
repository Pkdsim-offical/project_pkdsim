...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Dark.Galaxy_necklace
{
    public class Galaxy_NecklaceItem : MonoBehaviour
    {
        ...
        private class Galaxy_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
