...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Flying.Wings_necklace
{
    public class Wings_NecklaceItem : MonoBehaviour
    {
        ...
        private class Wings_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
