...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Ghost.Bone_necklace
{
    public class Bone_NecklaceItem : MonoBehaviour
    {
        ...
        private class Bone_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
