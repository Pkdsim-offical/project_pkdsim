...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Ghost.Shadow_necklace
{
    public class Shadow_NecklaceItem : MonoBehaviour
    {
        ...
        private class Shadow_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
