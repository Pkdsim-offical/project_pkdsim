...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Ghost.Spirit_necklace
{
    public class Spirit_NecklaceItem : MonoBehaviour
    {
        ...
        private class Spirit_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
