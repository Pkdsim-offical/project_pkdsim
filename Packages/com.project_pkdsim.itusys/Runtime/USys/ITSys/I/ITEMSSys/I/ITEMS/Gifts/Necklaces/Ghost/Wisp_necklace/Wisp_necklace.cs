...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Ghost.Wisp_necklace
{
    public class Wisp_NecklaceItem : MonoBehaviour
    {
        ...
        private class Wisp_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
