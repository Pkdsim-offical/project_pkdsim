...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Modules.LoadJson.Flying.Wings_necklace
{
    public class Wings_necklaceJsonLoader : MonoBehaviour
    {
        private Wings_NecklaceItem necklaceData;
        protected void LoadJson()
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                necklaceData = JsonConvert.DeserializeObject<Wings_NecklaceItem>(jsonContent);
        ...
        public void WingsNecklace_LoveSys_Stager()
        {
            LoadJson();
