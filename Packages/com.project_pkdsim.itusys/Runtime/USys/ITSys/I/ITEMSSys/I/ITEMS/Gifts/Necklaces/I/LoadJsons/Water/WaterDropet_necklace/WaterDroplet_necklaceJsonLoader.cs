...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Modules.LoadJson.Water.WaterDrop_necklace
{
    public class WaterDroplet_necklaceJsonLoader : MonoBehaviour
    {
        private Water_Droplet_NecklaceItem necklaceData;
        public void LoadJson()
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                necklaceData = JsonConvert.DeserializeObject<Water_Droplet_NecklaceItem>(jsonContent);
