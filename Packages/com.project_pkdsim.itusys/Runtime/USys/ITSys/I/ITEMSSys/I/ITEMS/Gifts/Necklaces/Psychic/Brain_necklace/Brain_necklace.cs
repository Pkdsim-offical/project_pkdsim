...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Necklaces.Psychic.Brain_necklace
{
    public class Brain_NecklaceItem : MonoBehaviour
    {
        ...
        private class Brain_Necklace_Item
        {
            public List<Sys_Properties> SYS_properties { get; set; }
        }
