...
namespace project_pkdsim.USys.UItemsSystemSys.Modules.ITEMS.ItemsScripts.Gifts.Rings.Modules.Elemental_Effect
{
    public class RingsElementalEffectPropertiesBase : MonoBehaviour
    {
